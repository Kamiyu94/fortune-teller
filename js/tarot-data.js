...
const TAROT_CARDS = [
  {
    ...
    "upright": {
      ...
      "desc": "現在的你，正站在一個全新的起點。那種胸口微微發緊、卻又帶著一絲麻癢的興奮感，是生命在邀請你擴張。作為你的教練，我想告訴你：這份「不確定性」並非威脅，而是最大的自由。你不需要帶上過去所有的重擔，那些曾經讓你受傷的背叛、那些被當作聽話工具的委屈，都可以留在過去之外。\n\n這張牌在指引你，找回內心那個尚未被世界定義的「本真」。這不是盲目，而是一種純粹的勇氣。肯定自己擁有隨時重頭來過的權利，你的價值不取決於你到達了哪裡，而在於你敢於出發的瞬間。深呼吸，感受空氣進入肺部，那是生命最原始的禮物。讓你輕裝上陣吧，前方雖有無數可能，但最美的風景，其實是你找回了自己的腳步節奏。"
    },
    "reversed": {
      "keywords": [
        "懸在半空的遲疑",
      ...
      "desc": "當愚者倒過來時，那份輕盈似乎變成了焦慮的失重。你可能感覺到一種急於逃離現狀的衝動，卻又害怕再次跌入坑洞；或者，你正因為害怕再次被辜負，而緊抓著不安不放。這是一個溫柔的提醒：冒險與魯莽之間，隔著一道名為「覺察」的防線。\n\n現在不是急著跳下去的時候，而是需要你先低頭看看自己的腳趾，是否真實地踩在土地上。你是否因為太想證明自己不再受控，反而讓自己陷入了另一種混亂？建議你先停下腳步，找回你的中心點。這不是停滯，而是在為下一次的跳躍校準方向。允許自己有「不敢」的時候，那也是一種對自我的誠實保護。\n\n來自文欣教練的獨特祝福：\n親愛的，我知道你曾選擇切斷某些連繫來保護自己的純粹。我要送給你的祝福是：「你不需要任何人作伴，也能走向豐盛。」 真正的自由不是去到遠方，而是當你獨自一人時，內心不再有喧囂的指責。願你能享受這份孤獨，把它釀成只有你懂的芬芳。"
    }
  },
  {
    "id": 1,
    ...
    "upright": {
      ...
      "desc": "你擁有實現目標所需的一切資源，運用你的技能和創造力，將想法轉化為現實。"
    },
    "reversed": {
      "keywords": [
        "欺騙",
  ...
  },
  {
    ...
    "upright": {
      ...
      "desc": "傾聽內心的聲音，相信你的直覺。答案存在於你的內心深處，靜心冥想可以帶來啟示。"
    },
    "reversed": {
      "keywords": [
        "秘密",
      ...
      "desc": "你可能忽略了重要的內在訊息，或有隱藏的事情即將浮出水面。"
    }
  },
  {
    "id": 3,
    ...
    "upright": {
      ...
      "desc": "代表豐富與繁榮，創造力和滋養能量流動。享受生活中的美好事物，關注身心健康。"
    },
    "reversed": {
      "keywords": [
        "依賴",
      ...
      "desc": "可能過度依賴他人，或忽略了自我照顧。重新連結你的創造力和內在力量。"
    }
  },
  {
    "id": 4,
    ...
    "upright": {
      ...
      "desc": "代表穩定和秩序，建立結構和規則來達成目標。展現領導力，承擔責任。"
    },
    "reversed": {
      "keywords": [],
      "desc": "過度控制或缺乏權威，需要找到平衡。可能面臨權力鬥爭或組織混亂。"
    }
  },
  {
    "id": 5,
    ...
    "upright": {
      ...
      "desc": "尋求精神指引或遵循傳統價值。可能需要導師的幫助，或加入某個團體組織。"
    },
    "reversed": {
      "keywords": [
        "反叛",
      ...
      "desc": "挑戰既有規則，尋找自己的道路。可能需要擺脫過時的信念體系。"
    }
  },
  {
    "id": 6,
    ...
    "upright": {
      ...
      "desc": "代表深刻的連結和重要的選擇。在關係中找到和諧，或面臨需要聽從內心的抉擇。"
    },
    "reversed": {
      "keywords": [
        "失衡",
      ...
      "desc": "關係中出現問題，或內心掙扎於困難的選擇。需要重新審視你的價值觀。"
    }
  },
  {
    "id": 7,
    ...
    "upright": {
      ...
      "desc": "憑藉堅定的意志力戰勝障礙。保持專注，掌控局面，勝利就在眼前。"
    },
    "reversed": {
      "keywords": [
        "失控",
      ...
      "desc": "失去控制或方向感，內在衝突阻礙前進。需要重新集中精力和意圖。"
    }
  },
  {
    "id": 8,
    ...
    "upright": {
      ...
      "desc": "真正的力量來自內心的平靜和自我控制。以溫柔和耐心面對挑戰，而非蠻力。"
    },
    "reversed": {
      "keywords": [
        "自我懷疑",
      ...
      "desc": "內心的恐懼或自我懷疑削弱了你的力量。需要重建自信和內在平衡。"
    }
  },
  {
    "id": 9,
    ...
    "upright": {
      ...
      "desc": "退一步進行深度反思和內在探索。獨處可以帶來洞察和智慧。"
    },
    "reversed": {
      "keywords": [
        "孤立",
      ...
      "desc": "可能過度孤立自己，或拒絕接受他人的幫助。平衡獨處與社交的需要。"
    }
  },
  {
    "id": 10,
    ...
    "upright": {
      ...
      "desc": "生命正在經歷重大轉變，順應變化的潮流。好運即將降臨，把握機會。"
    },
    "reversed": {
      "keywords": [
        "壞運",
      ...
      "desc": "可能遭遇不順或抗拒必要的改變。記住這只是暫時的，輪子終將轉動。"
    }
  },
  {
    "id": 11,
    ...
    "upright": {
      ...
      "desc": "真相將會揭露，正義將會實現。為自己的行為負責，尋求公平的解決方案。"
    },
    "reversed": {
      "keywords": [
        "不公",
      ...
      "desc": "可能面臨不公正的對待，或需要承認自己的錯誤。尋找內在的平衡。"
    }
  },
  {
    "id": 12,
    ...
    "upright": {
      ...
      "desc": "需要暫停行動，從不同角度看待事物。有時候放下才能獲得更多。"
    },
    "reversed": {
      "keywords": [
        "拖延",
      ...
      "desc": "過度拖延或不願意做出必要的改變。停止抵抗，接受當前的處境。"
    }
  },
  {
    "id": 13,
    ...
    "upright": {
      ...
      "desc": "一個階段的結束為新的開始鋪路。放下不再服務於你的事物，迎接轉變。"
    },
    "reversed": {
      "keywords": [
        "抗拒改變",
