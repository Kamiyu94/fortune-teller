...
const TAROT_CARDS = [
  {
    ...
    "upright": {
      ...
      "desc": "現在的你，正站在一個全新的起點。那種胸口微微發緊、卻又帶著一絲麻癢的興奮感，是生命在邀請你擴張。我想告訴你：這份「不確定性」並非威脅，而是最大的自由。你不需要帶上過去所有的重擔，那些曾經讓你受傷的背叛、那些被當作聽話工具的委屈，都可以留在過去之外。這張牌在指引你，找回內心那個尚未被世界定義的「本真」。這不是盲目，而是一種純粹的勇氣。肯定自己擁有隨時重頭來過的權利，你的價值不取決於你到達了哪裡，而在於你敢於出發的瞬間。深呼吸，感受空氣進入肺部，那是生命最原始的禮物。讓你輕裝上陣吧，前方雖有無數可能，但最美的風景，其實是你找回了自己的腳步節奏。"
    },
    "reversed": {
      "keywords": [
        "懸在半空的遲疑",
      ...
      "desc": "當愚者倒過來時，那份輕盈似乎變成了焦慮的失重。你可能感覺到一種急於逃離現狀的衝動，卻又害怕再次跌入坑洞；或者，你正因為害怕再次被辜負，而緊抓著不安不放。這是一個溫柔的提醒：冒險與魯莽之間，隔著一道名為「覺察」的防線。現在不是急著跳下去的時候，而是需要你先低頭看看自己的腳趾，是否真實地踩在土地上。你是否因為太想證明自己不再受控，反而讓自己陷入了另一種混亂？建議你先停下腳步，找回你的中心點。這不是停滯，而是在為下一次的跳躍校準方向。允許自己有「不敢」的時候，那也是一種對自我的誠實保護。【 親愛的，我知道你曾選擇切斷某些連繫來保護自己的純粹。我要送給你的祝福是：「你不需要任何人作伴，也能走向豐盛。」 真正的自由不是去到遠方，而是當你獨自一人時，內心不再有喧囂的指責。願你能享受這份孤獨，把它釀成只有你懂的芬芳。】"
    }
  },
  {
    "id": 1,
